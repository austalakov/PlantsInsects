...
REPAST_SIMPHONY_ROOT=$PWD/repast.simphony/repast.simphony.runtime_2.1.0
...
CP=$CP:$PWD/groovylib/groovy-all-2.1.5.jar

# Change to the Default Repast Simphony Directory
cd PlantsInsects

# Start the Model
java -Xss10M -Xmx400M -cp $CP repast.simphony.runtime.RepastMain  ./PlantsInsects.rs
